    ...
    public class ApplicationDbInitializer
    {
        public static void SeedData(ModelBuilder _modelBuilder)
        {
            ...
            _modelBuilder.Entity<Category>().HasData(
                new Category { Id = Guid.Parse("F96E3FD7-E977-47BC-B915-F8FDAB4981EB"), IsActive = true, Name = "Electronics" },
                new Category { Id = Guid.Parse("85C86B71-6777-46F3-88AF-EAC6F0082E1E"), IsActive = true, Name = "Books" }
            );
            _modelBuilder.Entity<Product>().HasData(
                new Product { Id = Guid.Parse("99B8F183-6CA5-4347-90B0-A6F30957902F"), Price = 999.9m, StockQuantity = 150, Name = "Laptop", CategoryId = Guid.Parse("F96E3FD7-E977-47BC-B915-F8FDAB4981EB")},
                new Product { Id = Guid.Parse("ED3B1792-7654-4F96-BC53-6E5397413AC0"), Price = 1200, StockQuantity = 200, Name = "Smartphone", CategoryId = Guid.Parse("F96E3FD7-E977-47BC-B915-F8FDAB4981EB") },
                new Product { Id = Guid.Parse("329FEFE4-B1A0-43A9-9E0C-3CEA070E1D65"), Price = 25, StockQuantity = 225, Name = "C# Programming Book", CategoryId = Guid.Parse("85C86B71-6777-46F3-88AF-EAC6F0082E1E") }
            );
        }
    }
}
